    ...
    return (
        <section id="home" className="hero-section">
            ...
            <div className="hero-actions">
                <a href="#projects" className="btn-pill btn-pill-primary" id="hero-view-work-btn">
                ...
                {resumeUrl ? (
                    ...
                    <a href="#contact" className="btn-pill btn-pill-outline" id="hero-resume-contact-btn">
                        My Resume <span>⤓</span>
                    </a>
                )}
            </div>
